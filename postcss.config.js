...
function transformSelector(prefix, selector, prefixedSelector) {
  // For root-level selectors, we need to apply to both:
  // - :host for Shadow DOM (content scripts)
  // - #my-ext for extension pages (popup, options)
  ...
  if (
    ...
    return `:host ${selector}, #my-ext ${selector}`;
  }
